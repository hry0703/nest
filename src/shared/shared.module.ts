...
@Global()
@Module({
    providers: [IsUserNameUniqueConstraint, ConfigurationService, UserService, UtilityService, RoleService],
    exports: [IsUserNameUniqueConstraint, ConfigurationService, UserService, UtilityService, RoleService],
    imports: [
